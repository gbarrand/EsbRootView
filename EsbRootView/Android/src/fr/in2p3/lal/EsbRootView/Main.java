...
package fr.in2p3.lal.EsbRootView;
...
public class Main extends NativeActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    //System.err.println("EsbRootView : debug : Main::onCreate : 015");
    ...
    if(action.compareTo(Intent.ACTION_VIEW)==0) {
      ...
      if(scheme.compareTo(ContentResolver.SCHEME_FILE)==0) {
        ...
        //Log.v("EsbRootView::Main::onCreate","File intent : "+
        //      action+" : "+intent.getDataString()+" : "+intent.getType()+" : "+name);
        String document_path = "/sdcard/Android/data/fr.in2p3.lal.EsbRootView/DOCUMENT";
        ...
        //Log.v("EsbRootView::Main::onCreate","Content intent : "+
        //      action+" : "+intent.getDataString()+" : "+intent.getType()+" : "+name);
        String document_path = "/sdcard/Android/data/fr.in2p3.lal.EsbRootView/DOCUMENT";
        uri_to_file(uri,document_path); 
...
/*
        ...
        Log.v("EsbRootView::Main::onCreate","http intent : "+
              action+" : "+intent.getDataString()+" : "+intent.getType());
        DownloadManager.Request r = new DownloadManager.Request(uri);
        r.setDestinationInExternalPublicDir("/sdcard/Android/data/fr.in2p3.lal.EsbRootView","DOCUMENT");
...
*/
  ...
  private void load_resources() {
    ...
    // app_dir is : /data/data/fr.in2p3.lal.EsbRootView/files
  ...
  private void uri_to_file(Uri a_uri,String a_file) {
    try {
      ...
      Log.e("EsbRootView::uri_to_file "," exception: " + e.getMessage());
    }
  }
